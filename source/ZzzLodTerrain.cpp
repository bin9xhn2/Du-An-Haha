...
#include "NewUISystem.h"								 //AntLag + Borderless
...
{
	if (g_pOption->m_Terrain == 0)			   //AntLag + Borderless
		EnableAlphaTest();					   //AntLag + Borderless
	...
	if (g_pOption->m_Terrain == 0) { TerrainFlag = TERRAIN_MAP_NORMAL; };		   //AntLag + Borderless
	RenderTerrainFrustrum(EditFlag);											   //AntLag + Borderless
