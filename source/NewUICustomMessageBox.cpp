...
{
	if (g_pReconnect->s_Data.ReconnectStatus == g_pReconnect->RECONNECT_STATUS_RECONNECT)  //Add Reconnect
	{  //Add Reconnect
		g_pReconnect->s_Data.ReconnectStatus = g_pReconnect->RECONNECT_STATUS_DISCONNECT;  //Add Reconnect
	}  //Add Reconnect
